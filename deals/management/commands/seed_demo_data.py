...
class Command(BaseCommand):
    ...
    def _seed_cost_items(self):
        specs = [
            ...
            ('floor_insulation_250', 'Пол утепление 250мм', 'sqm', 'floors', '1600.00', '950.00'),
            ('floor_laminate', 'Ламинат', 'sqm', 'floors', '900.00', '500.00'),
            ('floor_finish_laminate', 'Чистовое покрытие пола - ламинат', 'sqm', 'floors', '900.00', '500.00'),
            ('floor_finish_granite', 'Чистовое покрытие пола - керамогранит', 'sqm', 'floors', '1300.00', '700.00'),
            ('facade_linear_meters', 'Погонные метры наружного фасада', 'lm', 'walls', '1800.00', '1000.00'),
            ('partition_double', 'Погонные метры сдвоенных перегородок', 'lm', 'walls', '1600.00', '900.00'),
            ('partition_single', 'Погонные метры одинарных перегородок', 'lm', 'walls', '1200.00', '700.00'),
            ('finish_quarter_board', 'Интерьерная доска в четверть', 'lm', 'walls', '900.00', '500.00'),
            ('finish_ldsp', 'Отделка ЛДСП плитами', 'lm', 'walls', '1100.00', '650.00'),
            ('finish_gkl_paint', 'Отделка ГКЛ в 2 слоя с покраской', 'lm', 'walls', '1000.00', '600.00'),
            ('finish_mdf', 'Отделка МДФ панелями', 'lm', 'walls', '1300.00', '700.00'),
            ('finish_plywood_rail', 'Отделка Фанера/рейка', 'lm', 'walls', '950.00', '550.00'),
            ('finish_bathroom_tile', 'Отделка стен санузла керамогранитом', 'lm', 'walls', '1400.00', '900.00'),
            ...
            ('windows', 'Окна', 'pcs', 'openings', '18000.00', '3500.00'),
            ('interior_doors', 'Двери межкомнатные с комплектом доборов', 'pcs', 'openings', '22000.00', '4500.00'),
            ...
            ('roof_gable', 'Кровля двускатная', 'sqm', 'roof', '1900.00', '1000.00'),
            ('roof_flat', 'Кровля плоская', 'sqm', 'roof', '1600.00', '900.00'),
            ('panoramic_sections', 'Большие панорамные секции', 'pcs', 'openings', '45000.00', '7000.00'),
            ('bathrooms_count', 'Количество санузлов', 'pcs', 'bathroom', '45000.00', '15000.00'),
